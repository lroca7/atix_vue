<template>
  <div>
    ...
    <v-dialog class="order" v-model="dialogOrder" max-width="90%">
      <v-card>
        <v-card-title>JAJA {{ table.name }} </v-card-title>
        ...
        <v-card class="d-flex flex-row pb-6">
          <v-card class="dialog-order search-products">
            ...
            <v-col class="d-flex flex-wrap pt-0" cols="12" sm="12" md="12">
              <v-card
          ...
          <v-card class="order-resume pa-4">
            ...
            <template v-if="productsInOrder.length > 0">
              ...
              <div class="d-flex justify-space-between mt-10">
                ...
                <v-btn depressed color="orange" @click="sendPreInvoice">
                  Pre-Factura
                </v-btn>
                <v-btn depressed color="primary" @click="sendInvoice">
                  Pagar
                </v-btn>
              </div>
            </template>
    ...
    >
      <v-card class="pa-4">
        ...
        <div class="d-flex justify-end pa-6">
          ...
          <v-btn depressed color="success" @click="allowChangeProduct">
            Autorizar
          </v-btn>
        </div>
      </v-card>
    ...
    >
      <v-card class="pa-4">
        ...
        <div class="d-flex justify-end pa-6">
          ...
          <v-btn depressed color="success" @click="allowRemoveProduct">
            Autorizar
          </v-btn>
        </div>
      </v-card>
    ...
    <v-dialog class="invoice" v-model="dialogInvoice" max-width="50%">
      <v-card>
        ...
        <div class="d-flex justify-end pa-6">
          ...
          <v-btn depressed color="success" @click="newInvoice">
            Generar
          </v-btn>
        </div>
      </v-card>
...
export default {
  ...
  methods: {
    ...
    sendInvoice() {
      ...
      if (me.order.id) {
        ...
        if (me.order.preInvoice !== 'undefined') {
          console.log('La orden tiene prefactura activa')
          me.isLoadingClient = false
          me.Invoice.client = me.order.preInvoice.client
          // me.clients = [me.Invoice.client]
          // me.isLoadingClient = false

          me.isLoadingUser = false
          me.Invoice.user = me.order.preInvoice.responsable
          // me.users = [me.Invoice.user]
          // me.isLoadingUser = false
        }
      } else {
        alert('Primero genera la orden')
    ...
    newInvoice() {
      let me = this
      if (me.totalInvoice === null) {
        me.totalInvoice = me.totalOrder
      }
      let data = {
        tableInvoice: me.table.number,
        order: {
