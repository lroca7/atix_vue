<template>
  <v-card class="combo-option mb-6 pa-6">
    <v-row>
      <v-col cols="12" md="4">
        <v-text-field label="Nombre" v-model="nameOption"></v-text-field>
      </v-col>
    </v-row>
          ...
          <v-container>
            <v-row>
              ...
              <v-col cols="4" sm="4" md="4">
                <v-text-field v-model="amount" label="Cantidad"></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
    ...
    <v-row>
      <v-col cols="6" sm="6" md="6">
        <v-simple-table v-if="productosEnCombo && productosEnCombo.length > 0">
          <template v-slot:default>
            ...
            <tbody>
              <tr v-for="pc in productosEnCombo" :key="pc.product.id">
