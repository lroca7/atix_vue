      ...
      <v-tabs-items v-model="tab">
        ...
        <v-tab-item class="pa-6">
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row>
              ...
              <v-col cols="12" md="4">
                <v-checkbox label="Activo" v-model="product.state"></v-checkbox>
              </v-col>
            </v-row>

            <div
              v-if="product.productType && product.productType.value === '2'"
            >
              <p><b>Armar combos</b></p>
              <div v-for="c in comboOptions" :key="`${c.id}`">
                <combo-option v-on:createCombo="updateColor" :comboCharged="c">
                </combo-option>
              </div>
              <v-btn depressed color="info" @click="addComboOption">
                Agregar opcion
              </v-btn>
            </div>
          </v-form>
        ...
        <v-tab-item class="pa-6">
          <v-radio-group v-model="radios" :mandatory="false" row>
            <v-radio label="Con ingredientes" value="withIngredient"></v-radio>
            <v-radio label="Sin ingredientes" value="outIngredient"></v-radio>
          </v-radio-group>
          ...
          <v-row class="pa-4" v-if="radios === 'withIngredient'">
            <v-dialog v-model="dialogIngredient" max-width="700px">
              ...
              <v-card>
                ...
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn color="primary" @click="saveDialogIngredient"
                    >Guardar</v-btn
                  >
                  <v-btn
                    depressed
          ...
          <v-row>
            <v-col cols="6" sm="6" md="6">
              <v-simple-table
                v-if="ingredientesAgregados && ingredientesAgregados.length > 0"
              >
                ...
                <v-dialog v-model="dialog" max-width="700px">
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn depressed color="secondary" @click="closeDialog"
                        >Cancelar</v-btn
                      >
                    </v-card-actions>
                  </v-card>
...
export default {
  ...
  watch: {
    ...
    searchProductType() {
      // Items have already been loaded
      if (this.itemsProductType && this.itemsProductType.length > 1) return
