        ...
        <v-tab-item class="pa-6">
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row>
              ...
              <v-col cols="12" md="4">
                <v-text-field label="Costo" v-model="cost"></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-text-field label="Utilidad" v-model="utility"></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
                <v-checkbox
                  label="Inventariable"
              ...
              <v-col cols="12" md="4">
                <v-checkbox label="Activo" v-model="state"></v-checkbox>
              </v-col>
            </v-row>
